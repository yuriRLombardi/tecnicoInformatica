...
<body>
    ...
    <?php
        if (isset($_POST["id"]) && isset($_POST["nome"]) && isset($_POST["nick"]) && isset($_POST["datanasc"]) && isset($_POST["cidadenasc"]) && isset($_POST["cidademora"]) && isset($_POST["email"]) && isset($_POST["cor"]) && isset($_POST["time"]) && isset($_POST["usaoculos"]) && isset($_POST["signo"])) {
            $id = $_POST["id"];
            $nome = $_POST["nome"];
            $nick = $_POST["nick"]; 
            ...
            $signo = $_POST["signo"];
            $insercao = mysqli_query($conectar,"INSERT INTO `pwbb` (`ID`, `NOME`, `NICK`, `DATA_NASCIMENTO`, `CIDADE_NASCIMENTO`, `CIDADE_MORA`, `E_MAIL`, `COR_PREFERIDA`, `time`, `USA_OCULOS`, `SIGNO`) VALUES ($id,'$nome','$nick','$datanasc','$cidadenasc','$cidademora','$email','$cor','$time','$usaoculos','$signo')"); 
