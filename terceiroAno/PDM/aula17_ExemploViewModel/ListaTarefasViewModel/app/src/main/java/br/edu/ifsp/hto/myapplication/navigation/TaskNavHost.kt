...
// TODO(54) Definimos um objeto para representar a rota de listagem
@Serializable
object ListScreenRoute

// TODO(55) Definimos uma data class para representar a rota de adição/edição. Note que a rota
...
@Composable
fun TaskNavHost() {
    // TODO(56) Definimos um NavController
    val navController = rememberNavController()
    // TODO(57) Instanciamos o DAO aqui, assim todas as rotas têm acesso ao mesmo DAO.

    NavHost(navController = navController, startDestination = ListScreenRoute) {
        // TODO(58) Definimos uma rota para a listagem. Note que em navigateToAddEditScreen é
        ...
        // TODO(59) Definimos uma rota para a edição.
        composable<AddEditScreenRoute> { navBackStackEntry ->
            // TODO(60) Aqui recuperamos o objeto correspondnete à navegação. Isso permite
            ...
            // TODO(61) Chamamos o AddEditScreen, note que o taskId é extraído da rota
            //  addEditScreenRoute.
            AddEditScreen(
