...
// TODO(14) Na tela de listagem o nosso composable recebe o DAO e uma lambda para que seja possível
...
fun ListScreen(
    ...
    val tasksFlow = taskRepository.getAll()
    val tasks = tasksFlow.collectAsState(initial = emptyList())
        ...
        when (event) {
            ...
            is ListEvent.Delete -> {
                coroutineScope.launch {
                    taskRepository.delete(event.id)
                }
            }
...
// TODO(15) Aqui recebemos a lamba navigateToAddEditScreen, que contém a ação para navegar para a
...
fun ListScreenContent(
    ...
    // TODO(16) Utilizamos o Scaffold, que fornece um layout básico com botão de ação flutuante
    //  (FloatingActionButton),
    Scaffold(
        floatingActionButton = {
            FloatingActionButton(
                onClick = {
                    // TODO(17) Se estivermos criando uma nova tarefa, então navegamos para a tela
        ...
        LazyColumn(
            ...
            itemsIndexed(tasks) { index, task ->
                // TODO(18) Utilizamos um Card para representar cada item da lista de tarefas. Como
...
// TODO(19) O TaskCard representa um item da lista.
@Composable
fun TaskCard(
    task: Task,
    onEvent: (event: ListEvent) -> Unit,
