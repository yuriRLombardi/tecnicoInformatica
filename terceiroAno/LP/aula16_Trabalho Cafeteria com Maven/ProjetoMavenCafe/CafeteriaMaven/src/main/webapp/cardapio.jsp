...
<body>
	...
	<%
		...
		for(Produto produto: produtos){
			...
			out.print("<td><a href = 'CafeteriaController?operacao=Buscar&simbolo=lixeira&id="+produto.getId()+"'><img src='lixeira.png'height='20'></a></td>");
			out.print("<td><a href = 'CafeteriaController?operacao=Buscar&simbolo=editar&id="+produto.getId()+"'><img src='editar.png' height='20'></a></td>");
			out.print("</tr>");
		}
	%>
	</table>
